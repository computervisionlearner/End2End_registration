...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 14:31:28 2019
...
def get_unique_kps(image, name):
  ...
  kps_img = cv2.drawKeypoints(image, kps, None, flags=cv2.DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS)
...
if __name__ =="__main__":    
  ...
  parser.add_argument('--image1', default = '5_optical_qd_1.png', 
                      help = 'path to the left image')
  
  parser.add_argument('--image2', default = '5_SAR_qd.jpg',
  ...
  image1 = image1[:200, 200:460,:]
  image2 = cv2.imread(args['image2'])
  image2 = image2[100:300, 260:520,:]
